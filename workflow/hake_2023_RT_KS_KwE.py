...
date_time = now.strftime("%m-%b-%Y") #current date and time in ##-MON-YYYY formate

import json
with open('c:/rthomas/Pycode/Run_EchoPop/workflow/RT_params.json', 'r') as f:
    param_dict = json.load(f)      # Parsing the JSON file into a Python dictionary
#set parameters from jsonfile
DATA_ROOT=Path(param_dict["PATHCONFIG"]["DATA_ROOT"])
# set necessary paths, parameters here from json file
#for sub-directories of reports
Strata_name="KS" #
Exname="KwE" #
age1flag=0 #  0 for no age-1's, 1 for yes age-1's.
AGE1_DOMINATED_HAULS=None
####################################################################################################
# PARAMETER ENTRY
# ---------------
...
try: 
    ...
    VERBOSE = True
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# DATA ROOT DIRECTORY - now bring in from JSON
...
REPORTS_DIR = Path("C:/rthomas/Projects/EchoPop_validation/Reports/"+runyearstr+"/EchoPop/"+Strata_name+"/"+Exname+"/" )
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
BIODATA_FILE = DATA_ROOT / "Biological/Updated/1995-2025_Survey_Biodata.xlsx"
...
HAUL_STRATA_FILE = DATA_ROOT / Strata_year_path / "US&CAN strata 2023_EP_08-Jan-2025.xlsx"
#HAUL_STRATA_FILE = DATA_ROOT / "Stratification/US&CAN strata 2023_EP_08-Jan-2025.xlsx"
...
#GEOSTRATA_FILE = DATA_ROOT / "Stratification/Stratification_geographic_Lat_2023_EP_08-Jan-2025.xlsx"
GEOSTRATA_FILE = DATA_ROOT / Strata_year_path / "Stratification_geographic_Lat_2023_EP_08-Jan-2025.xlsx"
...
KRIGING_VARIOGRAM_PARAMETERS_FILE = (
    ...
    DATA_ROOT / "Kriging files & parameters/2023/default_vario_krig_settings_2023_US&CAN.xlsx"
)
...
if NASC_PREPROCESSED:
    ...
    match age1flag:
        case 0:
            match AGE1_DOMINATED_HAULS:
                case None:
                    logging.info(
                        f"No age-1 dominated hauls were excluded"
                    )
                case _:
...
df_nasc_use=df_nasc  #will change later if remove age-1
match age1flag:
    case 0:
        ############################### CHANGES FOR AGE-1 EXCLUSION ########################################
...
da_kriged_abundance_table_use =da_kriged_abundance_table   #"use" will get overwritten if remove age-1s 
da_kriged_biomass_table_use =da_kriged_biomass_table 
match age1flag:
    case 0:
        ############################### CHANGES FOR AGE-1 EXCLUSION ########################################
        ...
        ####################################################################################################
        da_kriged_abundance_table_use =da_kriged_abundance_table_noage1 
        da_kriged_biomass_table_use =da_kriged_biomass_table_noage1 
# ==================================================================================================
...
jh.stratified_bootstrap(data_df=df_nasc_use, 
...
reporter.total_length_haul_counts_report(
    filename="total_len_haul_counts.xlsx",
    sheetnames={"male": "Sheet1", "female": "Sheet2", "all": "Sheet3"},
...
reporter.kriged_aged_biomass_mesh_report(
    ...
    filename="EchoPro_kriged_aged_output-"+runyearstr+"_0.xlsx",
...
# Nonzero values
reporter.kriged_aged_biomass_mesh_report(
    #filename="EchoPro_kriged_aged_output-2023_1.xlsx",
    filename="EchoPro_kriged_aged_output-"+runyearstr+"_1.xlsx",
    sheetnames={"all": "Sheet1", "male": "Sheet2", "female": "Sheet3"},
...
reporter.kriged_mesh_results_report(
    ...
    filename="EchoPro_kriged_output-"+date_time+"_0.xlsx",
    sheetname="Sheet1",
    kriged_data=df_kriged_results,
...
reporter.kriged_mesh_results_report(
    ...
    filename="EchoPro_kriged_output-"+date_time+"_1.xlsx",
    sheetname="Sheet1",
    kriged_data=df_kriged_results[df_kriged_results["biomass"] > 0.],
    kriged_stratum="geostratum_ks",
    kriged_variable="biomass",
...
reporter.transect_aged_biomass_report(
    ...
    filename="EchoPro_un-kriged_aged_output-"+runyearstr+"_0.xlsx",
    sheetnames={"all": "Sheet1", "male": "Sheet2", "female": "Sheet3"},
    transect_data=df_nasc_use,
    weight_data=ds_da_weight_dist["aged"],
)
...
reporter.transect_aged_biomass_report(
    ...
    filename="EchoPro_un-kriged_aged_output-"+runyearstr+"_1.xlsx",
    sheetnames={"all": "Sheet1", "male": "Sheet2", "female": "Sheet3"},
    transect_data=df_nasc_use[df_nasc_use["biomass"] > 0.],
    weight_data=ds_da_weight_dist["aged"],
)
...
reporter.transect_population_results_report(
    ...
    filename="EchoPro_kriged_output-"+date_time+"_0.xlsx",
    sheetname="Sheet1",
    transect_data=df_nasc_use[df_nasc_use["nasc"] > 0.],
    weight_strata_data=da_averaged_weight,
    sigma_bs_stratum=invert_hake.sigma_bs_strata,
    stratum_name="stratum_ks",
)
