...
from echopop.workflows.nwfsc_feat.reporter import pivot_aged_weight_proportions
self = reporter
# Type checking
...
age_weight_data = age_weight_sums_filtered
# Type checking
...
age_weight_full.index = (
    pd.Series(age_weight_full.index).apply(lambda x: x.mid).values.astype(int)
)
