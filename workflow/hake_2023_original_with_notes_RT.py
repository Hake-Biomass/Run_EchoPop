...
df_binned_weights_all = feat_biology.length_binned_weights(
    ...
    impute_bins=True,
    minimum_count_threshold=5, #if fewer than 5 fish in a certain bin, uses a length-weight regression curve calculated earlier.  Otherwise uses the actual mean in that length bin
)
...
# AGED- specimen fish- sex based length-age key for each stratum
...
# ==================================================================================================
# COMPUTE NUMBER PROPORTIONS (goes from counts to proportions)Proportion - within stratum proportion. Aged proportions and unaged proportions will individually sum to 1 for each stratum.  Proportion overall - takes proportion from sum of aged and unaged  
logging.info(
